<?php
/* Smarty version 4.0.0, created on 2022-05-26 07:45:54
  from 'C:\xampp\htdocs\invent\4a801fc3\templates\riwayat.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_628f14121eee47_27966208',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '132ae96d64cd08dacf8f02792e7eee1d04ab9feb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\invent\\4a801fc3\\templates\\riwayat.tpl',
      1 => 1653543950,
      2 => 'file',
    ),
  ),
...
function content_628f14121eee47_27966208 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">Kode Barang</label>
                <input name="kode_barang" type="text" id="inputName" class="form-control" required="" value="<?php echo $_smarty_tpl->tpl_vars['kode_barang']->value;?>
">
              </div>
              <div class="form-group">
                <label for="inputName">Pemilik</label>
...
">
              ...
              <div class="form-group">
                <label for="inputName">Keterangan</label>
                <input name="ket" type="text" id="inputName" class="form-control" required="" value="<?php echo $_smarty_tpl->tpl_vars['ket']->value;?>
">
              </div>  
              <div class="custom-file">
                <label for="inputName">Foto</label>
...
">
              ...
              <div class="form-group">
                <label for="inputName">IP LAN</label>
                <input name="ip_lan" type="text" id="inputName" class="form-control" required="" value="<?php echo $_smarty_tpl->tpl_vars['ip_lan']->value;?>
">
              </div>
              <div class="form-group">
                <label for="inputName">Ada Wifi</label>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
$__section_cpu_3_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['view']->value) ? count($_loop) : max(0, (int) $_loop));
$__section_cpu_3_total = $__section_cpu_3_loop;
$_smarty_tpl->tpl_vars['__smarty_section_cpu'] = new Smarty_Variable(array());
if ($__section_cpu_3_total !== 0) {
for ($__section_cpu_3_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_cpu']->value['index'] = 0; $__section_cpu_3_iteration <= $__section_cpu_3_total; $__section_cpu_3_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_cpu']->value['index']++){
?>    
                <tr> 
                    <td></td>
                    <td></td>                    
