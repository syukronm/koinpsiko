<?php
/* Smarty version 4.0.0, created on 2022-05-31 04:30:51
  from 'C:\xampp\htdocs\judisium\templates\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_62957ddbcf9782_58639354',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '179108f4319c04a140068dad21d5a18035d92b97' => 
    array (
      0 => 'C:\\xampp\\htdocs\\judisium\\templates\\index.tpl',
      1 => 1653964233,
      2 => 'file',
    ),
  ),
...
function content_62957ddbcf9782_58639354 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<!--
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1 class="breadcrumb float-sm-right"> <?php echo $_smarty_tpl->tpl_vars['namaprodi']->value;?>
</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="form-group">
                <label for="inputName">Tahun</label>
                  <select name="tahun" required>
                    ...
                    <?php
$__section_x_0_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['tahun']->value) ? count($_loop) : max(0, (int) $_loop));
...
<!-- AdminLTE App -->
<?php echo '<script'; ?>
 src="uiux/dist/js/adminlte.min.js"><?php echo '</script'; ?>
>
<!-- AdminLTE for demo purposes -->
<?php echo '<script'; ?>
 src="uiux/dist/js/demo.js"><?php echo '</script'; ?>
>
<!-- jQuery -->
<?php echo '<script'; ?>
 src="uiux/plugins/jquery/jquery.min.js"><?php echo '</script'; ?>
...
<!-- Select2 -->
<?php echo '<script'; ?>
 src="uiux/plugins/select2/js/select2.full.min.js"><?php echo '</script'; ?>
>
<!-- Bootstrap4 Duallistbox -->
<?php echo '<script'; ?>
 src="uiux/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"><?php echo '</script'; ?>
>
<!-- InputMask -->
<?php echo '<script'; ?>
...
>
<?php echo '<script'; ?>
 src="uiux/plugins/inputmask/jquery.inputmask.min.js"><?php echo '</script'; ?>
>
<!-- date-range-picker -->
<?php echo '<script'; ?>
...
<!-- bootstrap color picker -->
<?php echo '<script'; ?>
 src="uiux/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"><?php echo '</script'; ?>
>
<!-- Tempusdominus Bootstrap 4 -->
<?php echo '<script'; ?>
...
<!-- Bootstrap Switch -->
<?php echo '<script'; ?>
 src="uiux/plugins/bootstrap-switch/js/bootstrap-switch.min.js"><?php echo '</script'; ?>
>
<!-- BS-Stepper -->
<?php echo '<script'; ?>
 src="uiux/plugins/bs-stepper/js/bs-stepper.min.js"><?php echo '</script'; ?>
>
<!-- dropzonejs -->
<?php echo '<script'; ?>
 src="uiux/plugins/dropzone/min/dropzone.min.js"><?php echo '</script'; ?>
>
<!-- AdminLTE App -->
<?php echo '<script'; ?>
 src="uiux/dist/js/adminlte.min.js"><?php echo '</script'; ?>
